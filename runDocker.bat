...
:: Needs work. Right now it rebuilds every time, which is unneccesary. Also go into docker desktop every once in a while and remove all iamges, builds, and containers to free drive space
